...
# Задание 2
 ...
 1. (0,1,2) Создан модуль `querylib содержащий методы для обработки данных wsgi запросов GET и POST. Для решения проблемы парсинга данных решено использовать библиотеку `urllib`. 
